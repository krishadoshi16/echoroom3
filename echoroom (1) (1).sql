...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2026 at 06:59 PM
...
(47, 'pbkdf2_sha256$600000$CwvQuBWBlVSew2k9u5XAgG$EwRYfBh6Q6Mp6DRhvE233+uKz/SXzLufB5uUg7H2Q5o=', NULL, 0, 'admincheck', '', '', 1, 1, '2026-03-26 17:17:06.438625', 'admin', 0, NULL, 0, NULL, 'admincheck@example.com'),
(48, 'pbkdf2_sha256$600000$oDFhcGx9yw4DyIdaW4nVHL$IYyZc/VINBsGNGFI+kaJQpC+x2A5VfTsgrxc7GUpR70=', NULL, 0, 'usercheck_403bc9', '', '', 0, 1, '2026-03-26 17:17:34.887320', 'registered', 0, NULL, 0, NULL, 'ud73074@x.com'),
(49, 'pbkdf2_sha256$600000$fs4dq08OSDVm24WG7rqkZo$HDAAcJf+Kd/udMM84Tb8Ag2KCUPe6JaYCDtagOtPkoY=', NULL, 0, 'Manushri Thakkarrr', '', '', 0, 1, '2026-03-26 17:22:02.966941', 'registered', 0, NULL, 0, NULL, 'thakkarmanushri308@gmail.com'),
(50, 'pbkdf2_sha256$600000$FyQx6fgNC1skVhpPfUFpuj$k1CCALj6nCKx+4mMD27PUATRI0s9hFEehMvDbhAlCEQ=', NULL, 0, 'Ruchita', '', '', 0, 1, '2026-03-26 17:51:49.967016', 'registered', 0, NULL, 0, NULL, 'rpatadiya2004@gmail.com'),
(51, 'pbkdf2_sha256$600000$11L2ReLqj7JbjZFpXYR5xv$OQTCJjbvzRqiTIHJRWWjzfStNpzOPpoNIyNvGnXJuVI=', NULL, 0, 'manya', '', '', 0, 1, '2026-03-26 18:50:41.462018', 'registered', 0, NULL, 0, NULL, 'manushrithakkar30@gmail.com'),
(52, 'pbkdf2_sha256$600000$1X0gKt07Qmr8o6Qne12A5N$a0dJq/dGCjGi9RWBm8LEo1o/JDerh4Bvn5ZRwuAzEdQ=', NULL, 0, 'manya thakkar', '', '', 0, 1, '2026-03-26 18:53:08.223682', 'registered', 0, NULL, 0, NULL, 'manushri.thakkar30@gmail.com'),
(53, 'pbkdf2_sha256$600000$hJ62hTxIZ8Jbjk5J2DnzD4$tO9RllUDxNB05GkBpa15l40rTqvBvz3FwxtX4g/4iEg=', NULL, 0, 'Siya Sharma', '', '', 0, 1, '2026-03-31 21:48:01.511436', 'registered', 0, NULL, 0, NULL, 'siya2023@gmail.com');
...
(41, 'Can add opinion report', 11, 'add_opinionreport'),
(42, 'Can change opinion report', 11, 'change_opinionreport'),
(43, 'Can delete opinion report', 11, 'delete_opinionreport'),
(44, 'Can view opinion report', 11, 'view_opinionreport');
...
(9, 'Suggest_645a38', 'from smoke', 'rejected', '2026-03-26 17:30:48.978773', '2026-03-26 17:17:35.379260', '2026-03-26 17:17:35.379287', 47, 48),
(10, 'finance', 'money', 'approved', '2026-03-26 17:30:44.806501', '2026-03-26 17:26:42.887094', '2026-03-26 17:26:42.887130', 47, 49),
(11, 'Mental Health', 'Mental wellbeing is also as important as physical wellbeing', 'approved', '2026-03-31 21:42:12.193715', '2026-03-31 21:42:12.194264', '2026-03-31 21:42:12.194286', 47, NULL);
...
(5, 'Smoke test topic', 'check', 'rejected', '2026-03-26 17:30:25.823727', '2026-03-26 17:17:35.366925', '2026-03-26 17:17:35.366956', 7, 48, 47),
(6, 'feminism', 'Feminism is a range of socio-political movements and ideologies aimed at defining, establishing, and achieving equal political, economic, personal, and social rights for all genders', 'approved', '2026-03-26 17:30:12.279141', '2026-03-26 17:25:34.086159', '2026-03-26 17:25:34.086684', 6, 49, 47),
(7, 'frminism', 'abcccc', 'approved', '2026-03-26 17:30:15.297623', '2026-03-26 17:27:01.944898', '2026-03-26 17:27:01.945031', 6, 49, 47),
(8, 'Is academic pressure harming students?', 'Academic pressure level is increased compared to older types', 'pending', NULL, '2026-03-31 21:44:42.566319', '2026-03-31 21:44:42.566364', 11, 47, NULL),
(9, 'Should human cloning be allowed?', 'Debate the ethical and scientific implications of cloning humans for medical or personal purposes.', 'pending', NULL, '2026-04-01 07:34:59.308336', '2026-04-01 07:34:59.308489', 3, 53, NULL);
...
(11, 'for', 'For centuries, women have faced discrimination in education, employment, and basic rights. Feminism works to remove these inequalities and ensure that everyone, regardless of gender, has equal opportunities.', '2026-04-01 07:36:27.307842', '2026-04-01 07:36:27.307926', 53, 6, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `debates_opinionreport`
--

CREATE TABLE `debates_opinionreport` (
  `id` bigint(20) NOT NULL,
...
(48, -1, '2026-04-01 07:36:57.945168', '2026-04-01 07:36:57.945212', 3, 53);
...
(21, 'debates', '0002_opinionreport', '2026-03-26 17:14:17.887756'),
(22, 'debates', '0003_rename_debates_opi_resolve_a24531_idx_debates_opi_resolve_d2dc89_idx', '2026-03-31 21:20:48.080503');
...
--
-- Indexes for table `debates_opinionreport`
--
ALTER TABLE `debates_opinionreport`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_report_per_user_per_opinion` (`opinion_id`,`reporter_id`),
  ADD KEY `debates_opinionreport_reporter_id_a7757869_fk_accounts_user_id` (`reporter_id`),
  ADD KEY `debates_opi_resolve_d2dc89_idx` (`resolved`,`created_at`);
...
--
-- AUTO_INCREMENT for table `debates_opinionreport`
--
ALTER TABLE `debates_opinionreport`
...
--
-- Constraints for table `debates_opinionreport`
--
ALTER TABLE `debates_opinionreport`
  ADD CONSTRAINT `debates_opinionreport_opinion_id_ad448fb9_fk_debates_opinion_id` FOREIGN KEY (`opinion_id`) REFERENCES `debates_opinion` (`id`),
  ADD CONSTRAINT `debates_opinionreport_reporter_id_a7757869_fk_accounts_user_id` FOREIGN KEY (`reporter_id`) REFERENCES `accounts_user` (`id`);
